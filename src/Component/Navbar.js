...
const Navbar = ({ isOpen,setRefresh}) => {
  ...
  return (
    <>
        ...
        <div className="ml-auto flex items-center space-x-4">
          <div className="relative">
            ...
            >
              ...
              <span className="text-gray-900 font-semibold">{userName|| "User"}</span>
            </button>
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-3 w-60 px-5 py-3 bg-white rounded-lg shadow-md border">
                <ul className="space-y-3 text-gray-900">
                  ...
                  <hr />
                  <li>
                    <button  onClick={handleLogout}  className="flex items-center space-x-3 text-red-600 hover:text-red-800">
                      <FiLogOut size={20} />
                      <span>Logout</span>
                    </button>
                  </li>
      ...
      {isModalOpen && <TaskModal setRefresh={setRefresh} closeModal={() => setIsModalOpen(false)} />}
    </>
  );
};
